...
// RunGooseUp applies pending goose migrations from dir (product SQL migrations).
func RunGooseUp(ctx context.Context, pool *pgxpool.Pool, migrationsPath string) error {
	if migrationsPath == "" {
		return nil
	}
