...
const (
	...
	TenantService_ListMyTenants_FullMethodName = "/tenant.v1.TenantService/ListMyTenants"
	...
	TenantService_AcceptInvite_FullMethodName  = "/tenant.v1.TenantService/AcceptInvite"
)
...
type TenantServiceClient interface {
	...
	AcceptInvite(ctx context.Context, in *AcceptInviteRequest, opts ...grpc.CallOption) (*TenantMembershipResponse, error)
}
...
func (c *tenantServiceClient) AcceptInvite(ctx context.Context, in *AcceptInviteRequest, opts ...grpc.CallOption) (*TenantMembershipResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TenantMembershipResponse)
	err := c.cc.Invoke(ctx, TenantService_AcceptInvite_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type TenantServiceServer interface {
	...
	AcceptInvite(context.Context, *AcceptInviteRequest) (*TenantMembershipResponse, error)
...
func (UnimplementedTenantServiceServer) AcceptInvite(context.Context, *AcceptInviteRequest) (*TenantMembershipResponse, error) {
...
func _TenantService_AcceptInvite_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AcceptInviteRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(TenantServiceServer).AcceptInvite(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: TenantService_AcceptInvite_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(TenantServiceServer).AcceptInvite(ctx, req.(*AcceptInviteRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var TenantService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _TenantService_AcceptInvite_Handler,
		},
	},
